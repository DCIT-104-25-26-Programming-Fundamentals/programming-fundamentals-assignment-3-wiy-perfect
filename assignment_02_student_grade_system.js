...
// getGrade()
// Evaluates the input score, checks bounds, and returns the letter grade or null.
...
// main()
// Handles terminal I/O and coordinates logic.
function main() {
    const score = readlineSync.questionInt("Enter student score (0-100): ");
    const grade = getGrade(score);

    // If getGrade returned null, print error; otherwise print grade.
    if (grade === null) {
...
// Execute the assignment application
main();